...
public class VariantConverterTest {
	...
	public void variant_has_correct_type() throws Exception {
		final Variant converted = subject.asVariant(MediaType.create("test",
				"type"));
	...
	@Test
	public void variant_has_correct_encoding() throws Exception {
		final Variant converted = subject.asVariant(MediaType.create("*", "*")
				.withCharset(Charsets.ISO_8859_1));
		assertEquals(Charsets.ISO_8859_1.name(), converted.getEncoding());
	}
	...
	public void content_type_is_equivalent() throws Exception {
		final javax.ws.rs.core.MediaType converted = subject
				.asContentType(MediaType.create("test", "type"));
	...
	public void encoding_is_equivalent() throws Exception {
		final javax.ws.rs.core.MediaType converted = subject
				.asContentType(MediaType.create("*", "*").withCharset(
						Charsets.ISO_8859_1));
		assertEquals(Charsets.ISO_8859_1.name(),
				converted.getParameters().get("charset"));
	}
}
