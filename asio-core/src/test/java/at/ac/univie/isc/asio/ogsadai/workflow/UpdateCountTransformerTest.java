...
public class UpdateCountTransformerTest {
  ...
  public void xml_transformation() throws Exception {
    ...
    final XmlUpdateCountTransformer transformer = new XmlUpdateCountTransformer(query);
    transformer.writeObject(out, count);
    final ByteArrayInputStream xml = new ByteArrayInputStream(out.toByteArray());
    final UpdateResult transformed = JAXB.unmarshal(xml, UpdateResult.class);
