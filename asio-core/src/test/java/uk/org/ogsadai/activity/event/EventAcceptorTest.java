...
public class EventAcceptorTest {
  ...
  @Test
  public void signal_continue_on_request_error_state_and_no_previous_exceptions() throws Exception {
    assertFalse(subject.handleStateAndStop(ERROR));
  }

  @Test
  public void signal_stop_on_request_error_state_and_previous_exceptions() throws Exception {
