...
public final class PipeElements {
   ...
   * 
   * @param activity wrapped activity
   ...
   * 
   * @param activity wrapped activity
   * @param input name of input pipe
   * @return consumer
   */
  ...
  /**
   * Create a wrapper that holds an activity that can produce and consume tuples
   * 
   * @param activity wrapped activity
   * @param input name of input pipe
   * @param output name of output pipe
  ...
  private static class ActivityWrapper implements ProducerAndConsumer {
    ...
    public String input() {
      if (inName == null) {
        throw new UnsupportedOperationException("not a consumer");
      }
      return inName;
    }
    ...
    public String output() {
      if (outName == null) {
        throw new UnsupportedOperationException("not a producer");
      }
      return outName;
    }
  }
