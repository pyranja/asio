...
/**
 * Forward activity errors to a {@link RequestListener} using the set request id.
 * 
...
public class ActivityErrorListener implements ActivityListener {
  ...
  public ActivityErrorListener(final RequestListener delegate, final ResourceID requestId) {
