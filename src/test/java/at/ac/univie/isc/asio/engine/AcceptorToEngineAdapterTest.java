...
public class AcceptorToEngineAdapterTest {
  ...
  private AcceptorToEngineAdapter subject;
  @Mock
  ...
  @Before
  public void setup() {
    subject = new AcceptorToEngineAdapter(adapted, MoreExecutors.sameThreadExecutor());
  }
