...
/**
 * Initialize the {@link uk.org.ogsadai.context.OGSADAIContext} on webapp start using the bean definition file specified as
...
public class OgsadaiContextLoaderListener implements ServletContextListener {
  ...
  /**
   * Generate a parent {@link org.springframework.context.ApplicationContext} holding the dynamic references to important
