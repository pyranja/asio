...
public class TestUtils {
   ...
   * @param given real value
   */
  public static void assertEqualsIgnoreCase(final String expected, final String given) {
    if (!expected.equalsIgnoreCase(given)) {
      throw new AssertionError("expected [" + expected + "] but was [" + given + "]");
    }
  }
   ...
   */
  private static StringBuilder appendEntity(final Object entity, final StringBuilder to) {
