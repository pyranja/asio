...
public class UrisTest {
  ...
  public void directory_path_uri_remains_as_is() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("//localhost/directory/"));
  ...
  public void set_to_root_path_if_no_path_given() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("//localhost"));
  ...
  public void ignore_opaque_uris() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("mailto:me@example.com"));
  ...
  public void keep_query_string_at_end_of_uri() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("//localhost/directory?key=value"));
    assertThat(actual.getPath(), is("/directory/"));
  ...
  public void keep_fragment_at_end_of_uri() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("//localhost/directory#fragment"));
    assertThat(actual.getPath(), is("/directory/"));
  ...
  public void supports_absolute_paths() throws Exception {
    final URI actual = Uris.ensureDirectoryPath(URI.create("/directory"));
    assertThat(actual.getPath(), is("/directory/"));
