...
public class AuthoritiesFilterTest {
  @Test
  public void should_yield_input_if_none_excluded() throws Exception {
    final AuthoritiesFilter subject = AuthoritiesFilter.exclude(AuthorityUtils.NO_AUTHORITIES);
  ...
  public void should_remove_excluded_authorities_from_input() throws Exception {
    final AuthoritiesFilter subject = AuthoritiesFilter.exclude(authorities("exclude-me"));
