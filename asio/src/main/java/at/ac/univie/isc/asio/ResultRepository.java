...
public interface ResultRepository {
	 ...
	 *             on IO error
	 */
	ResultHandler newHandlerFor(DatasetOperation operation)
			throws DatasetTransportException;

	/**
	 * Retrieve the (possible pending) results for the DatsetOperation with
	 * given id.
	 * 
	 * @param opId
	 *            of operation
	 ...
	 *             if no operation with given id is known
	 */
	ListenableFuture<Result> find(String opId)
