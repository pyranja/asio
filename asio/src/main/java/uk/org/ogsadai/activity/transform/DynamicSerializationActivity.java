...
/**
 * An activity that converts received {@link Object blocks} to a binary format,
 * using a {@link BlockTransformer} given as input. The result is output as an
 * OGSA-DAI list of <code>byte[]</code> of fixed size.
 * <p>
 * Activity inputs:
 * </p>
 * <ul>
 * <li>
 * <code>data</code> Type: Any object that is compatible to the given
 * <code>transformer</code>. The block that should be serialized.</li>
 * <li>
 * <code>transformer</code> Type: {@link BlockTransformer}. The transformer to
 * be used.</li>
 * </ul>
 * <p>
 * Activity outputs:
 ...
 * <ul>
 * <li>
 * The input block is read, transformed using the read transformer and emitted
 * as list of byte[].</li>
 * </ul>
 * 
...
public class DynamicSerializationActivity extends MatchedIterativeActivity {
	...
	private static final DAILogger LOG = DAILogger
			.getLogger(DynamicSerializationActivity.class);
	...
	protected ActivityInput[] getIterationInputs() {
		return new ActivityInput[] {
				new TypedActivityInput(INPUT_DATA, Object.class),
				new TypedActivityInput(INPUT_TRANSFORMER,
	...
	protected void processIteration(final Object[] iterationData)
		...
		final Object block = checkNotNull(iterationData[0],
				"missing serialization input");
		final BlockTransformer transformer = (BlockTransformer) checkNotNull(
				iterationData[1], "missing transformer");
